...
class RPSApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Rock-Paper-Scissors AI")
        ...
        # Widgets
        self.label_title = ctk.CTkLabel(self, text="Rock Paper Scissors", font=("Arial", 32))
        ...
        self.quit_btn = ctk.CTkButton(self, text="Quit", command=self.destroy)
    ...
    def play_round(self):
        ...
        ai_move = random.choice(list(gesture_map.values()))
